...
export default function Landing() {
  ...
  > = {
    ...
    cover: {
      ...
      angle: "45° (Deep extra cover - Off-side)",
    ...
    straight: {
      ...
      angle: "90° (Straight down the ground)",
    ...
    pull: {
      ...
      angle: "150° (Deep square leg - Leg-side)",
    ...
    square: {
      ...
      angle: "0° / 360° (Point / Deep point - Off-side)",
