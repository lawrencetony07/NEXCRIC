...
export default function Landing() {
  ...
  > = {
    ...
    cover: {
      ...
      angle: "45° (Deep extra cover - Off-side, Bottom-Left)",
    ...
    on: {
      ...
      angle: "110° (Mid-on - Leg-side, Bottom-Right-Center)",
    ...
    square: {
      ...
      angle: "0° / 360° (Point / Deep point - Off-side, Mid-Left)",
    ...
    sweep: {
      ...
      angle: "180° (Square leg - Leg-side, Mid-Right)",
    ...
    cut: {
      ...
      angle: "315° (Third man - Off-side, Top-Left)",
    ...
    glance: {
      ...
      angle: "225° (Fine leg - Leg-side, Top-Right)",
            ...
            <div className="lg:col-span-5 flex flex-col items-center justify-center space-y-4">
              <div className="p-4 rounded-2xl bg-[#03060a] border border-white/5 shadow-inner flex items-center justify-center relative overflow-hidden">
                ...
                <svg viewBox="0 0 320 320" className="w-full max-w-[280px] sm:max-w-[320px] aspect-square overflow-visible">
                  ...
                  {/* Off-Side & Leg-Side text tags (Off-side Left, Leg-side Right) */}
                  ...
                  <AnimatePresence initial={false}>
                    ...
                    {(activeStadiumShot === 'all' || activeStadiumShot === 'cover') && (
                      <g>
                        ...
                        />
                        <circle cx="65" cy="255" r="4.5" className="fill-[#10b981] animate-pulse" />
                      </g>
                    )}
                    ...
                    {(activeStadiumShot === 'all' || activeStadiumShot === 'on') && (
                      <g>
                        <motion.path
                          ...
                          transition={{ duration: 0.6 }}
                        />
                        <circle cx="200" cy="285" r="4.5" className="fill-[#00ffb2] animate-pulse" />
                      </g>
                    )}
                    ...
                    {(activeStadiumShot === 'all' || activeStadiumShot === 'square') && (
                      <g>
                        <motion.path
                          ...
                          transition={{ duration: 0.6 }}
                        />
                        <circle cx="15" cy="140" r="4.5" className="fill-[#f59e0b] animate-pulse" />
                      </g>
                    )}
                    ...
                    {(activeStadiumShot === 'all' || activeStadiumShot === 'sweep') && (
                      <g>
                        <motion.path
                          ...
                          transition={{ duration: 0.6 }}
                        />
                        <circle cx="305" cy="140" r="4.5" className="fill-[#d946ef] animate-pulse" />
                      </g>
                    )}
                    ...
                    {(activeStadiumShot === 'all' || activeStadiumShot === 'cut') && (
                      <g>
                        <motion.path
                          ...
                          transition={{ duration: 0.6 }}
                        />
                        <circle cx="40" cy="45" r="4.5" className="fill-[#ff6b35] animate-pulse" />
                      </g>
                    )}
                    ...
                    {(activeStadiumShot === 'all' || activeStadiumShot === 'glance') && (
                      <g>
                        <motion.path
                          ...
                          transition={{ duration: 0.6 }}
                        />
                        <circle cx="280" cy="55" r="4.5" className="fill-[#3b82f6] animate-pulse" />
                      </g>
                    )}
                  </AnimatePresence>
