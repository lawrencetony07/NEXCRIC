  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        >
          <div className="p-6 rounded-2xl bg-white dark:bg-darkbg-700 shadow-sm relative overflow-hidden group w-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <SpecularCard
            ...
            className="w-full flex"
          >
            <div className="p-6 rounded-2xl bg-white dark:bg-darkbg-700 shadow-sm relative overflow-hidden w-full h-full">
          ...
          <SpecularCard
            ...
            className="w-full flex"
          >
            <div className="p-6 rounded-2xl bg-white dark:bg-darkbg-700 shadow-sm w-full h-full">
        ...
        <div className="space-y-6">
          ...
          <SpecularCard
            ...
            className="w-full flex"
          >
            <div className="p-6 rounded-2xl bg-gradient-to-br from-slate-50 to-slate-100 dark:from-darkbg-700 dark:to-darkbg-800 shadow-sm relative overflow-hidden w-full h-full">
            ...
            return (
              ...
              >
                <div 
                  ...
                  className="group bg-white dark:bg-darkbg-700/80 backdrop-blur-sm rounded-xl overflow-hidden w-full h-full transition-all duration-300"
                >
